...
ALIVE_LOGO = getenv("ALIVE_LOGO", "https://telegra.ph//file/5cb0e3dad80b79a32e7eb.jpg")
...
CHANNEL = getenv("CHANNEL", "t.me/junkthings")
...
REPO_URL = getenv("REPO_URL", "https://github.com/iamuput/Tikus-Userbot")
